...
namespace YAML
{
	...
	struct convert<glm::vec4>
	{
		...
		static bool decode(Node node, glm::vec4& rhs)
		{
...
namespace Engine
{
	...
	{
		out << YAML::BeginMap;
		out << YAML::Key << "Entity" << YAML::Value << "3134134123465"; //TODO: Entity ID goes here
		...
		if (entities)
		{
			for (auto entity : entities)
			{
				...
				if (spriteRendererComponent)
				{
					...
					auto& color = deserializedEntity.GetComponent<SpriteRendererComponent>().Color;
